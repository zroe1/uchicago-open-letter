          ...
          <section id="letter" className="max-w-3xl">
            ...
            <div className="max-w-none text-[17px] md:text-[19px] leading-7 md:leading-8 space-y-5">
              ...
              <p>
                ...
                faculty—was directed to come up with proposals for consolidating sixteen humanities
                ...
                studies departments. At the same time, the University directed the Languages Working
                Group, also consisting of instructors and faculty in AHD, to propose a minimum
                number of students required for any language class to run, and even the wholesale
                elimination of certain languages within the division.
              </p>
              <p>
              ...
              <p>
                ...
                We urge readers to consult Clifford Ando’s published analyses of the University’s
                finances, which lay bare the true scope of the problem. The Board of Trustees using
                the Trump administration’s budgetary moves as cover to unilaterally push through
                long-desired restructuring is not only dishonest—it is a betrayal of its commitments
                to the intellectual community that supports it.
              </p>
              <p>
              ...
              <p>
                ...
                diversity in scholarship. They an affront to students and parents who pay
